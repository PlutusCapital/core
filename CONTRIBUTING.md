Contributing to PLUTUS Core
============================

The PLUTUS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/plutus-project/plutus/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PLUTUS Core project, and is not to be
confused with overall PLUTUS Network Protocol consensus changes.

Whether a pull request is merged into PLUTUS Core rests with the project merge
...
Patches that change PLUTUS consensus rules are considerably more involved than
...
Where a patchset proposes to change the PLUTUS consensus, it must have been
...
The project leader is the release manager for each PLUTUS Core release.
