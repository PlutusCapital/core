...
This means one can have an always-on plutusd instance running, and another local plutusd/plutus-qt instance which connects to this node and receives blocks from it.
