...
RESOURCES += src/qt/plutus.qrc src/qt/plutus_locale.qrc

TRANSLATIONS += src/qt/locale/plutus_bg.ts \
                src/qt/locale/plutus_de.ts \
                src/qt/locale/plutus_en.ts \
                src/qt/locale/plutus_es.ts \
                src/qt/locale/plutus_fi.ts \
                src/qt/locale/plutus_fr.ts \
                src/qt/locale/plutus_it.ts \
                src/qt/locale/plutus_ja.ts \
                src/qt/locale/plutus_pl.ts \
                src/qt/locale/plutus_pt.ts \
                src/qt/locale/plutus_ru.ts \
                src/qt/locale/plutus_sk.ts \
                src/qt/locale/plutus_sv.ts \
                src/qt/locale/plutus_vi.ts \
                src/qt/locale/plutus_zh_CN.ts \
                src/qt/locale/plutus_zh_TW.ts
