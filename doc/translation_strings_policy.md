...
This document provides guidelines for internationalization of the PLUTUS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `plutus_en.ts` remains unchanged.
