...
<<<<<<< HEAD
plutus.conf           | contains configuration settings for pivxd or pivx-qt
plutusd.pid           | stores the process id of pivxd while running
=======
plutus.conf           | contains configuration settings for plutusd or plutus-qt
plutusd.pid           | stores the process id of plutusd while running
>>>>>>> develop
...
debug.log           | contains debug information and general logging generated by plutusd or plutus-qt
