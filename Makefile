...
pkgdatadir = $(datadir)/plutus
pkgincludedir = $(includedir)/plutus
pkglibdir = $(libdir)/plutus
pkglibexecdir = $(libexecdir)/plutus
...
CONFIG_HEADER = $(top_builddir)/src/config/plutus-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/plutus-config.h.in \
...
ACLOCAL = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = plutus-cli
BITCOIN_DAEMON_NAME = plutusd
BITCOIN_GUI_NAME = plutus-qt
BITCOIN_TX_NAME = plutus-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = plutus
PACKAGE_BUGREPORT = www.plutus.org
PACKAGE_NAME = Plutus Core
PACKAGE_STRING = Plutus Core 3.4.99
PACKAGE_TARNAME = plutus
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/rails/shanu-26-02-2019/projects/c++/PIVX
abs_srcdir = /home/rails/shanu-26-02-2019/projects/c++/PIVX
abs_top_builddir = /home/rails/shanu-26-02-2019/projects/c++/PIVX
abs_top_srcdir = /home/rails/shanu-26-02-2019/projects/c++/PIVX
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/rails/shanu-26-02-2019/projects/c++/PIVX/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/plutus-cli.bash-completion \
	       $(top_srcdir)/contrib/plutus-tx.bash-completion \
	       $(top_srcdir)/contrib/plutusd.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/plutus.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/plutus16.xpm \
  $(top_srcdir)/share/pixmaps/plutus32.xpm \
  $(top_srcdir)/share/pixmaps/plutus128.png
...
COVERAGE_INFO = baseline.info \
  test_plutus_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_plutus_coverage.info test_plutus.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/PLUTUS-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/plutus-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/plutus-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/plutus-config.h
$(top_srcdir)/src/config/plutus-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/plutus-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/PLUTUS-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PLUTUS-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PLUTUS-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_plutus.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_plutus -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_plutus_filtered.info: test_plutus.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_plutus_filtered.info
...
#test_plutus_coverage.info: baseline_filtered.info test_plutus_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_plutus_filtered.info -o $@

#total_coverage.info: test_plutus_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_plutus_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_plutus.coverage/.dirstamp:  test_plutus_coverage.info
...
#cov: test_plutus.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_plutus.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
