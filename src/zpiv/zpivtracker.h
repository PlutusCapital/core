...
#ifndef PLUTUS_ZPLTTRACKER_H
#define PLUTUS_ZPLTTRACKER_H
...
public:
    CzPLTTracker(std::string strWalletFile);
    ~CzPLTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPLTWallet* zPLTWallet = NULL);
