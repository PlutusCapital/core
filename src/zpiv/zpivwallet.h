...
#ifndef PLUTUS_ZPLTWALLET_H
#define PLUTUS_ZPLTWALLET_H
...
public:
    CzPLTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPLT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPLT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
