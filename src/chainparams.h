 ...
 * PLUTUS system. There are three: the main network on which people trade goods
...
public:
    ...
    int PlutusBadBlockTime() const { return nPlutusBadBlockTime; }
    int PlutusBadBlocknBits() const { return nPlutusBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nPlutusBadBlockTime;
    unsigned int nPlutusBadBlocknBits;
