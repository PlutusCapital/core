...
#include "qt/plutus/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(PLUTUSGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive PLT."));
