...
#include "qt/plutus/coincontrolpltwidget.h"
#include "qt/plutus/forms/ui_coincontrolpltwidget.h"

CoinControlPltWidget::CoinControlPltWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlPltWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select PLT Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("PLT");
    ...
    ui->labelValueAfter->setText("0.00 PLT");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 PLT");
    ui->labelValueFee->setText("0.00 PLT");
...
CoinControlPltWidget::~CoinControlPltWidget()
{
    delete ui;
}
