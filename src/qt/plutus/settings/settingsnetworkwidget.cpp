...
#include "qt/plutus/settings/settingsnetworkwidget.h"
#include "qt/plutus/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/plutus/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PLUTUSGUI* _window, QWidget *parent) :
