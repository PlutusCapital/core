...
#include "qt/plutus/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/plutus/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PLUTUSGUI* _window, QWidget *parent) :
