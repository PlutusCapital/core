...
#include "qt/plutus/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/plutus/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PLUTUSGUI* _window, QWidget *parent) :
