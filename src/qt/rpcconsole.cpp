                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPLTPathCustom = GetArg("-zpltbackuppath", "");
    ...
    if(!strzPLTPathCustom.empty()) {
        ui->wallet_customzpltbackuppath->setText(QString::fromStdString(strzPLTPathCustom));
        ui->wallet_customzpltbackuppath_label->setVisible(true);
        ui->wallet_customzpltbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPLTPathCustom.empty()) && nCustomBackupThreshold > 0) {
