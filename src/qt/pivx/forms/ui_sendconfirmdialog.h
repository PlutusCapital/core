...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -178, 556, 680));
...
"}"));
    ...
    {
        TxDetailDialog->setWindowTitle(QApplication::translate("TxDetailDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("TxDetailDialog", "Transaction Details", 0));
        btnEsc->setText(QString());
        labelId->setText(QApplication::translate("TxDetailDialog", "ID:", 0));
        textId->setText(QApplication::translate("TxDetailDialog", "492526e7fa3c810b35016...40a5df85ee227ab00b1156994", 0));
        pushCopy->setText(QString());
        labelDivider9->setText(QString());
        labelSend->setText(QApplication::translate("TxDetailDialog", "Sending to: ", 0));
        textSend->setText(QApplication::translate("TxDetailDialog", "D7VFR83SQbiezrW72hjcWJtcfip5krte2Z ", 0));
        pushOutputs->setText(QString());
        labelDivider8->setText(QString());
        labelAmount->setText(QApplication::translate("TxDetailDialog", "Total amount", 0));
        textAmount->setText(QApplication::translate("TxDetailDialog", "2 PIV", 0));
        labelDivider6->setText(QString());
        labelInputs->setText(QApplication::translate("TxDetailDialog", "Coin inputs:", 0));
        textInputs->setText(QApplication::translate("TxDetailDialog", "1 Inputs", 0));
        pushInputs->setText(QString());
        labelTitlePrevTx->setText(QApplication::translate("TxDetailDialog", "Previous Transaction", 0));
        labelOutputIndex->setText(QApplication::translate("TxDetailDialog", "Output Index", 0));
        labelDivider1->setText(QString());
        labelFee->setText(QApplication::translate("TxDetailDialog", "Fee:", 0));
        textFee->setText(QApplication::translate("TxDetailDialog", "0.0001 PIV", 0));
        labelDivider2->setText(QString());
        labelChange->setText(QApplication::translate("TxDetailDialog", "Change address:", 0));
        textChange->setText(QApplication::translate("TxDetailDialog", "D7VFR83SQbie\342\200\246BhjcWJtcfip5krte2Z ", 0));
        labelDivider4->setText(QString());
        labelConfirmations->setText(QApplication::translate("TxDetailDialog", "Confirmations:", 0));
        textConfirmations->setText(QApplication::translate("TxDetailDialog", "12", 0));
        labelDivider7->setText(QString());
        labelSize->setText(QApplication::translate("TxDetailDialog", "Size:", 0));
        textSize->setText(QApplication::translate("TxDetailDialog", "2 kB", 0));
        labelDivider3->setText(QString());
        labelDate->setText(QApplication::translate("TxDetailDialog", "Date:", 0));
        textDate->setText(QApplication::translate("TxDetailDialog", "May 25, 2017", 0));
        labelDivider5->setText(QString());
        labelStatus->setText(QApplication::translate("TxDetailDialog", "Status:", 0));
        textStatus->setText(QApplication::translate("TxDetailDialog", "Spendable", 0));
        labelWarning->setText(QApplication::translate("TxDetailDialog", "TextLabel", 0));
        btnCancel->setText(QApplication::translate("TxDetailDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("TxDetailDialog", "OK", 0));
    } // retranslateUi
