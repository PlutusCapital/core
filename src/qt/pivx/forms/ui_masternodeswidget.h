...
public:
    ...
    {
        MasterNodesWidget->setWindowTitle(QApplication::translate("MasterNodesWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("MasterNodesWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("MasterNodesWidget", "TextLabel", 0));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("MasterNodesWidget", "No active Master Node yet", 0));
        pushButtonSave->setText(QApplication::translate("MasterNodesWidget", "PushButton", 0));
    } // retranslateUi
