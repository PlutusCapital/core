...
public:
    ...
    {
        DenomGenerationDialog->setWindowTitle(QApplication::translate("DenomGenerationDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("DenomGenerationDialog", "Transaction Details", 0));
        btnEsc->setText(QApplication::translate("DenomGenerationDialog", "PushButton", 0));
        labelMessage->setText(QApplication::translate("DenomGenerationDialog", "This will unlock your wallet fully, so that anyone with access to it can spend until the wallet is closed or locked again.", 0));
        checkBox5000->setText(QApplication::translate("DenomGenerationDialog", "5000", 0));
        checkBox100->setText(QApplication::translate("DenomGenerationDialog", "100", 0));
        checkBox10->setText(QApplication::translate("DenomGenerationDialog", "10", 0));
        checkBox1000->setText(QApplication::translate("DenomGenerationDialog", "1000", 0));
        checkBox50->setText(QApplication::translate("DenomGenerationDialog", "50", 0));
        checkBox500->setText(QApplication::translate("DenomGenerationDialog", "500", 0));
        checkBox5->setText(QApplication::translate("DenomGenerationDialog", "5", 0));
        checkBox1->setText(QApplication::translate("DenomGenerationDialog", "1", 0));
        checkBoxAll->setText(QApplication::translate("DenomGenerationDialog", "Select All", 0));
        btnCancel->setText(QApplication::translate("DenomGenerationDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("DenomGenerationDialog", "SAVE", 0));
    } // retranslateUi
