...
public:
    ...
    void setupUi(QWidget *PrivacyWidget)
    {
        ...
        btnTotalzPIV = new OptionButton(right);
        btnTotalzPIV->setObjectName(QStringLiteral("btnTotalzPIV"));
        btnTotalzPIV->setMinimumSize(QSize(0, 50));

        verticalLayout_5->addWidget(btnTotalzPIV);
    ...
    {
        PrivacyWidget->setWindowTitle(QApplication::translate("PrivacyWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("PrivacyWidget", "Title", 0));
        labelSubtitle1->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("PrivacyWidget", "PushButton", 0));
        pushRight->setText(QApplication::translate("PrivacyWidget", "PushButton", 0));
        labelSubtitle2->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelSubtitleAmount->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        pushButtonSave->setText(QApplication::translate("PrivacyWidget", "PushButton", 0));
        labelListHistory->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("PrivacyWidget", "No active Master Node yet", 0));
        labelTitleDenom1->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom1->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom5->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom5->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom10->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom10->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom50->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom50->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom100->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom100->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom500->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom500->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom1000->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom1000->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelTitleDenom5000->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
        labelValueDenom5000->setText(QApplication::translate("PrivacyWidget", "TextLabel", 0));
    } // retranslateUi
