...
public:
    ...
    {
        CSRow->setWindowTitle(QApplication::translate("CSRow", "Form", 0));
        labelName->setText(QApplication::translate("CSRow", "Savings", 0));
        labelAmount->setText(QApplication::translate("CSRow", "0,00 PIV", 0));
        labelAddress->setText(QApplication::translate("CSRow", "address", 0));
        labelStaking->setText(QApplication::translate("CSRow", "Not Staking", 0));
