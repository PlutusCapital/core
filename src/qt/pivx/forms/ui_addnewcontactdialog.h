...
public:
    ...
    {
        AddNewContactDialog->setWindowTitle(QApplication::translate("AddNewContactDialog", "Dialog", 0));
        labelTitle->setText(QApplication::translate("AddNewContactDialog", "TextLabel", 0));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("AddNewContactDialog", "TextLabel", 0));
        btnCancel->setText(QApplication::translate("AddNewContactDialog", "CANCEL", 0));
        btnOk->setText(QApplication::translate("AddNewContactDialog", "OK", 0));
    } // retranslateUi
