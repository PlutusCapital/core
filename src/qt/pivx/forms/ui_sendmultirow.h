...
"padding:0px;"));
    ...
    {
        SendMultiRow->setWindowTitle(QApplication::translate("SendMultiRow", "Form", 0));
        btnMenu->setText(QString());
        labelSubtitleDescription->setText(QApplication::translate("SendMultiRow", "TextLabel", 0));
    } // retranslateUi
