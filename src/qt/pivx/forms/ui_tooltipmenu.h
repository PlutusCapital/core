...
public:
    ...
    {
        TooltipMenu->setWindowTitle(QApplication::translate("TooltipMenu", "Form", 0));
        btnCopy->setText(QApplication::translate("TooltipMenu", "Copy", 0));
        btnEdit->setText(QApplication::translate("TooltipMenu", "Edit", 0));
        btnDelete->setText(QApplication::translate("TooltipMenu", "Delete", 0));
        btnLast->setText(QApplication::translate("TooltipMenu", "Last", 0));
    } // retranslateUi
