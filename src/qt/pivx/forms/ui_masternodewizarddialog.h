...
public:
    ...
    {
        MasterNodeWizardDialog->setWindowTitle(QApplication::translate("MasterNodeWizardDialog", "Dialog", 0));
        pushButtonSkip->setText(QString());
        pushNumber1->setText(QApplication::translate("MasterNodeWizardDialog", "1", 0));
        labelLine1->setText(QString());
        pushNumber3->setText(QApplication::translate("MasterNodeWizardDialog", "2", 0));
        labelLine3->setText(QString());
        pushNumber4->setText(QApplication::translate("MasterNodeWizardDialog", "3", 0));
        groupBoxName->setTitle(QString());
        pushName1->setText(QApplication::translate("MasterNodeWizardDialog", "Intro", 0));
        pushName3->setText(QApplication::translate("MasterNodeWizardDialog", "Name", 0));
        pushName4->setText(QApplication::translate("MasterNodeWizardDialog", "Address", 0));
        labelTitle1->setText(QApplication::translate("MasterNodeWizardDialog", "Create New Master Node Controller", 0));
        labelMessage1a->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>To create a PIVX Masternode you must dedicate 10.000 PIV (the unit of PIVX) to the network (however, these coins are still yours and will never leave your possession). </p><p></p><p>You can deactivate the node and unlock the coins at any time.</p></body></html>", 0));
        labelMessage1b->setText(QApplication::translate("MasterNodeWizardDialog", "Make sure you have this amount of coins.", 0));
        labelTitle3->setText(QApplication::translate("MasterNodeWizardDialog", "Set Master Node\342\200\231s Name", 0));
        labelMessage3->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>A transaction of 10,000 PIV will be made</p><p>to a new empty address in your wallet.</p><p>The Address is labeled under the master node's name.</p></body></html>", 0));
        labelTitle4->setText(QApplication::translate("MasterNodeWizardDialog", "Set Master Node\342\200\231s IP and port", 0));
        labelSubtitleAddressIp->setText(QApplication::translate("MasterNodeWizardDialog", "Address of the node that must always be online running the actual master node.", 0));
        labelSubtitleIp->setText(QApplication::translate("MasterNodeWizardDialog", "Enter IP address", 0));
        labelSubtitlePort->setText(QApplication::translate("MasterNodeWizardDialog", "Enter Port", 0));
        btnBack->setText(QApplication::translate("MasterNodeWizardDialog", "CANCEL", 0));
        btnNext->setText(QApplication::translate("MasterNodeWizardDialog", "OK", 0));
    } // retranslateUi
