...
"                   padding:0px;"));
        ...
        labelListHistory = new QLabel(containerHistoryLabel);
    ...
    {
        ColdStakingWidget->setWindowTitle(QApplication::translate("ColdStakingWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("ColdStakingWidget", "Title", 0));
        labelSubtitle1->setText(QApplication::translate("ColdStakingWidget", "TextLabel", 0));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("ColdStakingWidget", "PushButton", 0));
        pushRight->setText(QApplication::translate("ColdStakingWidget", "PushButton", 0));
        labelSubtitle2->setText(QApplication::translate("ColdStakingWidget", "TextLabel", 0));
        labelEditTitle->setText(QString());
        labelSubtitleDescription->setText(QApplication::translate("ColdStakingWidget", "Owner Address (optional, if empty a new address will be created)", 0));
        pushButtonClear->setText(QString());
        pushButtonSend->setText(QString());
        labelListHistory->setText(QApplication::translate("ColdStakingWidget", "List of delegated balance by address", 0));
        labelStakingTotal->setText(QApplication::translate("ColdStakingWidget", "Total", 0));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("ColdStakingWidget", "No balance delegated", 0));
    } // retranslateUi
