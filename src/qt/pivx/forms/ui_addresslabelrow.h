...
public:
    ...
    {
        AddressLabelRow->setWindowTitle(QApplication::translate("AddressLabelRow", "Form", 0));
        lblLabel->setText(QApplication::translate("AddressLabelRow", "Bob Allen", 0));
        lblAddress->setText(QApplication::translate("AddressLabelRow", "DN6i46dytMPVhV1JMGZFuQBh7BZZ6nNLox", 0));
