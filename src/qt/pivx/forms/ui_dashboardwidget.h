...
"}"));
    ...
    {
        DashboardWidget->setWindowTitle(QApplication::translate("DashboardWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("DashboardWidget", "Transactions", 0));
        labelSubtitle->setText(QApplication::translate("DashboardWidget", "You can see here the history of your account", 0));
        imgWarning->setText(QString());
        lblWarning->setText(QApplication::translate("DashboardWidget", "Warning", 0));
        lblDivisory->setText(QString());
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("DashboardWidget", "No transactions", 0));
        btnHowTo->setText(QApplication::translate("DashboardWidget", "PushButton", 0));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Staking Rewards", 0));
        labelMessage->setText(QApplication::translate("DashboardWidget", "TextLabel", 0));
        labelAmountPiv->setText(QApplication::translate("DashboardWidget", "TextLabel", 0));
        labelAmountZpiv->setText(QApplication::translate("DashboardWidget", "TextLabel", 0));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking statistics", 0));
        labelSquarePiv->setText(QString());
        labelPiv->setText(QApplication::translate("DashboardWidget", "PIV", 0));
        labelSquarezPiv->setText(QString());
        labelZpiv->setText(QApplication::translate("DashboardWidget", "zPIV", 0));
        pushButtonChartArrow->setText(QString());
        pushButtonChartRight->setText(QString());
        groupBoxChart->setTitle(QApplication::translate("DashboardWidget", "Sort by", 0));
        pushButtonMonth->setText(QApplication::translate("DashboardWidget", "Days", 0));
        pushButtonYear->setText(QApplication::translate("DashboardWidget", "Months", 0));
        pushButtonAll->setText(QApplication::translate("DashboardWidget", "Years", 0));
        container_chart_dropboxes->setTitle(QApplication::translate("DashboardWidget", "Filter by", 0));
        pushImgEmptyChart->setText(QString());
        labelEmptyChart->setText(QApplication::translate("DashboardWidget", "LabelText", 0));
        labelMessageEmpty->setText(QApplication::translate("DashboardWidget", "TextLabel", 0));
    } // retranslateUi
