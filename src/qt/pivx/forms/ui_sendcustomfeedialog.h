...
public:
    ...
    {
        SendCustomFeeDialog->setWindowTitle(QApplication::translate("SendCustomFeeDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("SendCustomFeeDialog", "Transaction Details", 0));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("SendCustomFeeDialog", "Customize the transaction fee at your to your liking, depending on the fee value your transaction will be included or not in the blockchain.", 0));
        groupBox->setTitle(QString());
        checkBoxRecommended->setText(QApplication::translate("SendCustomFeeDialog", "Recomended", 0));
        labelFee->setText(QApplication::translate("SendCustomFeeDialog", "0.00 KB", 0));
        checkBoxCustom->setText(QApplication::translate("SendCustomFeeDialog", "Custom", 0));
        labelCustomFee->setText(QApplication::translate("SendCustomFeeDialog", "Per kilobyte", 0));
        btnCancel->setText(QApplication::translate("SendCustomFeeDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("SendCustomFeeDialog", "OK", 0));
    } // retranslateUi
