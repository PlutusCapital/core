...
public:
    ...
    {
        LoadingDialog->setWindowTitle(QApplication::translate("LoadingDialog", "Form", 0));
        labelMovie->setText(QApplication::translate("LoadingDialog", "TextLabel", 0));
        labelMessage->setText(QApplication::translate("LoadingDialog", "Loading", 0));
        labelDots->setText(QApplication::translate("LoadingDialog", ".", 0));
    } // retranslateUi
