...
public:
    ...
    {
        MyAddressRow->setWindowTitle(QApplication::translate("MyAddressRow", "Form", 0));
        labelName->setText(QApplication::translate("MyAddressRow", "Savings", 0));
        labelDate->setText(QApplication::translate("MyAddressRow", "Jan. 19, 2019", 0));
        labelAddress->setText(QApplication::translate("MyAddressRow", "DN6i46dytMPVhV1JMGZFuQBh7BZZ6nNLox", 0));
    } // retranslateUi
