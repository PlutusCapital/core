...
public:
    ...
    {
        AddressesWidget->setWindowTitle(QApplication::translate("AddressesWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("AddressesWidget", "Send", 0));
        labelSubtitle1->setText(QApplication::translate("AddressesWidget", "TextLabel", 0));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("AddressesWidget", "No active Master Node yet", 0));
        labelName->setText(QApplication::translate("AddressesWidget", "Contact name", 0));
        labelAddress->setText(QApplication::translate("AddressesWidget", "Enter address", 0));
        btnSave->setText(QApplication::translate("AddressesWidget", "OK", 0));
    } // retranslateUi
