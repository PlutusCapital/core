...
public:
    ...
    {
        DefaultDialog->setWindowTitle(QApplication::translate("DefaultDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("DefaultDialog", "Transaction Details", 0));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("DefaultDialog", "Text Label", 0));
        btnCancel->setText(QApplication::translate("DefaultDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("DefaultDialog", "SAVE", 0));
    } // retranslateUi
