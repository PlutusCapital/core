...
public:
    ...
    {
        WalletPasswordDialog->setWindowTitle(QApplication::translate("WalletPasswordDialog", "Dialog", 0));
        labelTitle->setText(QApplication::translate("WalletPasswordDialog", "TextLabel", 0));
        btnEsc->setText(QApplication::translate("WalletPasswordDialog", "PushButton", 0));
        labelMessage->setText(QApplication::translate("WalletPasswordDialog", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.", 0));
        labelPassword->setText(QApplication::translate("WalletPasswordDialog", "TextLabel", 0));
        labelPasswordRepeat->setText(QApplication::translate("WalletPasswordDialog", "TextLabel", 0));
        btnCancel->setText(QApplication::translate("WalletPasswordDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("WalletPasswordDialog", "OK", 0));
    } // retranslateUi
