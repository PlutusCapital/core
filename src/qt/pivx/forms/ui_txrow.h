...
public:
    ...
    {
        TxRow->setWindowTitle(QApplication::translate("TxRow", "Form", 0));
        icon->setText(QString());
        lblAddress->setText(QApplication::translate("TxRow", "Received from Bob", 0));
        lblDate->setText(QApplication::translate("TxRow", "18/05/18", 0));
        lblAmount->setText(QApplication::translate("TxRow", "+0.000585 PIV", 0));
