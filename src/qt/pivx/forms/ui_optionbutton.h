...
public:
    ...
    {
        OptionButton->setWindowTitle(QApplication::translate("OptionButton", "Form", 0));
        labelCircle->setText(QString());
        labelTitleChange->setText(QApplication::translate("OptionButton", "TextLabel", 0));
        labelSubtitleChange->setText(QApplication::translate("OptionButton", "TextLabel", 0));
