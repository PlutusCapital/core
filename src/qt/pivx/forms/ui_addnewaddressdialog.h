...
public:
    ...
    {
        AddNewAddressDialog->setWindowTitle(QApplication::translate("AddNewAddressDialog", "Dialog", 0));
        labelTitle->setText(QApplication::translate("AddNewAddressDialog", "My Address", 0));
        labelQrImg->setText(QString());
        labelAddress->setText(QApplication::translate("AddNewAddressDialog", "Address", 0));
        pushButtonCopy->setText(QApplication::translate("AddNewAddressDialog", "PushButton", 0));
        btnCancel->setText(QApplication::translate("AddNewAddressDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("AddNewAddressDialog", "OK", 0));
    } // retranslateUi
