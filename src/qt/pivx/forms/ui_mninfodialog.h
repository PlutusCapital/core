...
"}"));
    ...
    {
        MnInfoDialog->setWindowTitle(QApplication::translate("MnInfoDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("MnInfoDialog", "Master Node Information", 0));
        btnEsc->setText(QString());
        labelId->setText(QApplication::translate("MnInfoDialog", "Public Key:", 0));
        textId->setText(QApplication::translate("MnInfoDialog", "492526e7fa3c810b35016...40a5df85ee227ab00b1156994", 0));
        pushCopy->setText(QString());
        labelDivider9->setText(QString());
        labelSend->setText(QApplication::translate("MnInfoDialog", "Address: ", 0));
        textAddress->setText(QApplication::translate("MnInfoDialog", "127.0.0.2:43223", 0));
        labelDivider8->setText(QString());
        labelAmount->setText(QApplication::translate("MnInfoDialog", "Collaterall tx id:", 0));
        textAmount->setText(QApplication::translate("MnInfoDialog", "492526e7fa3c810b35016...40a5df85ee227ab00b1156994", 0));
        pushCopyId->setText(QString());
        labelDivider6->setText(QString());
        labelInputs->setText(QApplication::translate("MnInfoDialog", "Output index:", 0));
        textInputs->setText(QApplication::translate("MnInfoDialog", "1 Inputs", 0));
        labelDivider1->setText(QString());
        labelFee->setText(QApplication::translate("MnInfoDialog", "Status:", 0));
        textStatus->setText(QApplication::translate("MnInfoDialog", "MISSING", 0));
        labelDivider4->setText(QString());
        textExport->setText(QApplication::translate("MnInfoDialog", "Export data to run the Master Node on a remote server", 0));
