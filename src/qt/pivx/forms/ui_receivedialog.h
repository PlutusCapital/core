...
public:
    ...
    {
        ReceiveDialog->setWindowTitle(QApplication::translate("ReceiveDialog", "Dialog", 0));
        labelTitle->setText(QApplication::translate("ReceiveDialog", "Transaction Details", 0));
        btnEsc->setText(QApplication::translate("ReceiveDialog", "PushButton", 0));
        labelQrImg->setText(QString());
        labelAddress->setText(QApplication::translate("ReceiveDialog", "D7VFR83SQbiezrW72hjcWJtcfip5krte2Z ", 0));
        btnCancel->setText(QApplication::translate("ReceiveDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("ReceiveDialog", "OK", 0));
    } // retranslateUi
