...
public:
    ...
    {
        ReceiveWidget->setWindowTitle(QApplication::translate("ReceiveWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("ReceiveWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("ReceiveWidget", "TextLabel", 0));
        labelQrImg->setText(QString());
        labelLabel->setText(QApplication::translate("ReceiveWidget", "TextLabel", 0));
        labelDate->setText(QApplication::translate("ReceiveWidget", "TextLabel", 0));
        labelAddress->setText(QApplication::translate("ReceiveWidget", "No address", 0));
        pushButtonLabel->setText(QApplication::translate("ReceiveWidget", "Add Label", 0));
        pushButtonNewAddress->setText(QApplication::translate("ReceiveWidget", "Generate Address", 0));
        pushButtonCopy->setText(QApplication::translate("ReceiveWidget", "Copy", 0));
    } // retranslateUi
