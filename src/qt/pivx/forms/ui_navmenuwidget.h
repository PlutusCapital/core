...
"margin:0px;"));
        ...
        btnColdStaking = new QToolButton(navContainer_2);
        ...
        navContainer->addWidget(btnColdStaking);
    ...
    {
        NavMenuWidget->setWindowTitle(QApplication::translate("NavMenuWidget", "Form", 0));
        ...
        labelVersion->setText(QApplication::translate("NavMenuWidget", "V 1.0.0", 0));
    } // retranslateUi
