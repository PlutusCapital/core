...
public:
    ...
    {
        SendChangeAddressDialog->setWindowTitle(QApplication::translate("SendChangeAddressDialog", "Dialog", 0));
        labelTitle->setText(QApplication::translate("SendChangeAddressDialog", "Transaction Details", 0));
        btnEsc->setText(QApplication::translate("SendChangeAddressDialog", "PushButton", 0));
        labelMessage->setText(QApplication::translate("SendChangeAddressDialog", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.", 0));
        btnCancel->setText(QApplication::translate("SendChangeAddressDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("SendChangeAddressDialog", "OK", 0));
    } // retranslateUi
