...
public:
    ...
    {
        MNRow->setWindowTitle(QApplication::translate("MNRow", "Form", 0));
        labelName->setText(QApplication::translate("MNRow", "user_masternode", 0));
        labelAddress->setText(QApplication::translate("MNRow", "Address: 88.26.164.88:51474", 0));
        labelDate->setText(QApplication::translate("MNRow", "Jan. 19, 2019", 0));
