...
public:
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("RequestDialog", "New Request Payment", 0));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("RequestDialog", "Lorem ipsum dolor sit amet, consectur cling elit, sed do ", 0));
        labelSubtitleAmount->setText(QApplication::translate("RequestDialog", "Amount", 0));
        comboBoxCoin->setText(QApplication::translate("RequestDialog", "PIV", 0));
        labelSubtitleLabel->setText(QApplication::translate("RequestDialog", "TextLabel", 0));
        labelSubtitleDescription->setText(QApplication::translate("RequestDialog", "TextLabel", 0));
        labelQrImg->setText(QString());
        labelAddress->setText(QApplication::translate("RequestDialog", "D7VFR83SQbiezrW72hjcWJtcfip5krte2Z ", 0));
        btnCopyAddress->setText(QApplication::translate("RequestDialog", "COPY ADDRESS", 0));
        btnCopyUrl->setText(QApplication::translate("RequestDialog", "COPY URL", 0));
        btnCancel->setText(QApplication::translate("RequestDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("RequestDialog", "REQUEST", 0));
    } // retranslateUi
