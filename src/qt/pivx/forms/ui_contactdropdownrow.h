...
public:
    ...
    {
        ContactDropdownRow->setWindowTitle(QApplication::translate("ContactDropdownRow", "Form", 0));
        lblLabel->setText(QApplication::translate("ContactDropdownRow", "Bob Allen", 0));
        lblAddress->setText(QApplication::translate("ContactDropdownRow", "DN6i46dytMPVhV1JMGZFuQBh7BZZ6nNLox", 0));
