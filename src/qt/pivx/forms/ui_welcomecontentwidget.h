...
public:
    ...
    {
        WelcomeContentWidget->setWindowTitle(QApplication::translate("WelcomeContentWidget", "Dialog", 0));
        pushButtonSkip->setText(QString());
        pushNumber1->setText(QApplication::translate("WelcomeContentWidget", "1", 0));
        labelLine1->setText(QString());
        pushNumber2->setText(QApplication::translate("WelcomeContentWidget", "2", 0));
        labelLine2->setText(QString());
        pushNumber3->setText(QApplication::translate("WelcomeContentWidget", "3", 0));
        labelLine3->setText(QString());
        pushNumber4->setText(QApplication::translate("WelcomeContentWidget", "4", 0));
        groupBoxName->setTitle(QString());
        pushName1->setText(QApplication::translate("WelcomeContentWidget", "Language", 0));
        pushName2->setText(QApplication::translate("WelcomeContentWidget", "Welcome", 0));
        pushName3->setText(QApplication::translate("WelcomeContentWidget", "Privacy", 0));
        pushName4->setText(QApplication::translate("WelcomeContentWidget", "Masternodes", 0));
        labelTitle1->setText(QApplication::translate("WelcomeContentWidget", "Select your language", 0));
        labelTitle2->setText(QApplication::translate("WelcomeContentWidget", "Welcome to\n"
"PIVX Core Wallet", 0));
        labelMessage2->setText(QApplication::translate("WelcomeContentWidget", "PIVX is the world\342\200\231s most innovative Proof of Stake blockchain based technology. Developed by a team of highly experienced developers and cryptographers.", 0));
        labelTitle3->setText(QApplication::translate("WelcomeContentWidget", "How PIVX respects your privacy?", 0));
        labelMessage3->setText(QApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom to share their data whenever and with whomever they want - PIVX believes in self sovereignty.</p></body></html>", 0));
        labelTitle4->setText(QApplication::translate("WelcomeContentWidget", "What is a Masternode?", 0));
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "The masternode network is PIVX's second layer network on top of the blockchain that enables our DAO to provide decentralized governance and a treasury.", 0));
    } // retranslateUi
