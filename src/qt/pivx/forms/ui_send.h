...
"             }"));
    ...
    {
        send->setWindowTitle(QApplication::translate("send", "Form", 0));
        labelTitle->setText(QApplication::translate("send", "Send", 0));
        labelSubtitle1->setText(QApplication::translate("send", "TextLabel", 0));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("send", "PushButton", 0));
        pushRight->setText(QApplication::translate("send", "PushButton", 0));
        labelSubtitle2->setText(QApplication::translate("send", "TextLabel", 0));
        labelSubtitleAddress->setText(QApplication::translate("send", "TextLabel", 0));
        labelSubtitleAmount->setText(QApplication::translate("send", "TextLabel", 0));
        pushButtonFee->setText(QApplication::translate("send", "PushButton", 0));
        pushButtonClear->setText(QApplication::translate("send", "PushButton", 0));
        pushButtonAddRecipient->setText(QApplication::translate("send", "PushButton", 0));
        labelTitleTotalSend->setText(QApplication::translate("send", "TextLabel", 0));
        labelAmountSend->setText(QApplication::translate("send", "TextLabel", 0));
        labelLine->setText(QString());
        labelTitleTotalRemaining->setText(QApplication::translate("send", "TextLabel", 0));
        labelAmountRemaining->setText(QApplication::translate("send", "TextLabel", 0));
        pushButtonSave->setText(QApplication::translate("send", "PushButton", 0));
        pushButtonReset->setText(QApplication::translate("send", "PushButton", 0));
    } // retranslateUi
