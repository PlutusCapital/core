...
#include "qt/plutus/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/plutus/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PLUTUSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PLUTUSGUI::handleRestart()
