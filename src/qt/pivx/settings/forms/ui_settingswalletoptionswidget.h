...
public:
    ...
    {
        SettingsWalletOptionsWidget->setWindowTitle(QApplication::translate("SettingsWalletOptionsWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        labelTitleStake->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        groupBox->setTitle(QString());
        radioButtonSpend->setText(QApplication::translate("SettingsWalletOptionsWidget", "CheckBox", 0));
        labelDivider->setText(QString());
        labelTitleNetwork->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        labelSubtitleNetwork->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        groupBox_1->setTitle(QString());
        checkBoxMap->setText(QApplication::translate("SettingsWalletOptionsWidget", "RadioButton", 0));
        checkBoxAllow->setText(QApplication::translate("SettingsWalletOptionsWidget", "RadioButton", 0));
        checkBoxConnect->setText(QApplication::translate("SettingsWalletOptionsWidget", "RadioButton", 0));
        labelSubtitleProxy->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        labelSubtitlePort->setText(QApplication::translate("SettingsWalletOptionsWidget", "TextLabel", 0));
        pushButtonReset->setText(QApplication::translate("SettingsWalletOptionsWidget", "Reset to default", 0));
        pushButtonClean->setText(QApplication::translate("SettingsWalletOptionsWidget", "Discard changes", 0));
        pushButtonSave->setText(QApplication::translate("SettingsWalletOptionsWidget", "PushButton", 0));
    } // retranslateUi
