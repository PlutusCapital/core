...
public:
    ...
    {
        SettingsMultisendWidget->setWindowTitle(QApplication::translate("SettingsMultisendWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsMultisendWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("SettingsMultisendWidget", "TextLabel", 0));
        groupBox->setTitle(QString());
        pushLeft->setText(QString());
        pushRight->setText(QString());
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("SettingsMultisendWidget", "No active Master Node yet", 0));
        checkBoxStake->setText(QApplication::translate("SettingsMultisendWidget", "CheckBox", 0));
        checkBoxRewards->setText(QApplication::translate("SettingsMultisendWidget", "CheckBox", 0));
