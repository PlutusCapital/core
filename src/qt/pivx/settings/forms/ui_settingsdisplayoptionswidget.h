...
public:
    ...
    {
        SettingsDisplayOptionsWidget->setWindowTitle(QApplication::translate("SettingsDisplayOptionsWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        labelTitleLanguage->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        labelTitleUnit->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        labelTitleDigits->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        pushButtonSwitchBalance->setText(QApplication::translate("SettingsDisplayOptionsWidget", "PushButton", 0));
        labelTitleUrl->setText(QApplication::translate("SettingsDisplayOptionsWidget", "TextLabel", 0));
        pushButtonReset->setText(QApplication::translate("SettingsDisplayOptionsWidget", "Reset to default", 0));
        pushButtonClean->setText(QApplication::translate("SettingsDisplayOptionsWidget", "Discard changes", 0));
        pushButtonSave->setText(QApplication::translate("SettingsDisplayOptionsWidget", "PushButton", 0));
    } // retranslateUi
