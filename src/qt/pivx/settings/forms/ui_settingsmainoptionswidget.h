...
public:
    ...
    {
        SettingsMainOptionsWidget->setWindowTitle(QApplication::translate("SettingsMainOptionsWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsMainOptionsWidget", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("SettingsMainOptionsWidget", "TextLabel", 0));
        pushSwitchStart->setText(QString());
        labelTitleSizeDb->setText(QApplication::translate("SettingsMainOptionsWidget", "TextLabel", 0));
        labelTitleThreads->setText(QApplication::translate("SettingsMainOptionsWidget", "TextLabel", 0));
        labelDivider->setText(QString());
        labelTitleDown->setText(QApplication::translate("SettingsMainOptionsWidget", "Window", 0));
        labelSubtitleDown->setText(QApplication::translate("SettingsMainOptionsWidget", "Customize the application window options", 0));
        checkBoxMinTaskbar->setText(QApplication::translate("SettingsMainOptionsWidget", "CheckBox", 0));
        checkBoxMinClose->setText(QApplication::translate("SettingsMainOptionsWidget", "CheckBox", 0));
        pushButtonReset->setText(QApplication::translate("SettingsMainOptionsWidget", "Reset to default", 0));
        pushButtonClean->setText(QApplication::translate("SettingsMainOptionsWidget", "Discard changes", 0));
        pushButtonSave->setText(QApplication::translate("SettingsMainOptionsWidget", "SAVE", 0));
    } // retranslateUi
