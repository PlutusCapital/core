...
public:
    ...
    {
        SettingsMultisendDialog->setWindowTitle(QApplication::translate("SettingsMultisendDialog", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsMultisendDialog", "Transaction Details", 0));
        btnEsc->setText(QString());
        labelSubtitleAddress->setText(QApplication::translate("SettingsMultisendDialog", "TextLabel", 0));
        labelSubtitlePercentage->setText(QApplication::translate("SettingsMultisendDialog", "TextLabel", 0));
        lineEditPercentage->setText(QString());
        labelSubtitleLabel->setText(QApplication::translate("SettingsMultisendDialog", "TextLabel", 0));
        btnCancel->setText(QApplication::translate("SettingsMultisendDialog", "CANCEL", 0));
        btnSave->setText(QApplication::translate("SettingsMultisendDialog", "SAVE", 0));
    } // retranslateUi
