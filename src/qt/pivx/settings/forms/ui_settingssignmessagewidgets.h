...
"}"));
    ...
    {
        SettingsSignMessageWidgets->setWindowTitle(QApplication::translate("SettingsSignMessageWidgets", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        labelSubtitle1->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        groupBox->setTitle(QString());
        pushSign->setText(QApplication::translate("SettingsSignMessageWidgets", "PushButton", 0));
        pushVerify->setText(QApplication::translate("SettingsSignMessageWidgets", "PushButton", 0));
        labelSubtitleSwitch->setText(QString());
        labelSubtitleAddress->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        labelSubtitleMessage->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        labelSubtitleSignature->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        statusLabel_SM->setText(QApplication::translate("SettingsSignMessageWidgets", "TextLabel", 0));
        pushButtonClear->setText(QApplication::translate("SettingsSignMessageWidgets", "Clear", 0));
        pushButtonSave->setText(QApplication::translate("SettingsSignMessageWidgets", "PushButton", 0));
    } // retranslateUi
