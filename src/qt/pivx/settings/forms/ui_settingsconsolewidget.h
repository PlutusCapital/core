...
public:
    ...
    {
        SettingsConsoleWidget->setWindowTitle(QApplication::translate("SettingsConsoleWidget", "Form", 0));
        labelTitle->setText(QApplication::translate("SettingsConsoleWidget", "TextLabel", 0));
        pushButtonOpenDebug->setText(QApplication::translate("SettingsConsoleWidget", "PushButton", 0));
        pushButtonCommandOptions->setText(QApplication::translate("SettingsConsoleWidget", "PushButton", 0));
