...
#include "qt/plutus/settings/settingssignmessagewidgets.h"
#include "qt/plutus/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(PLUTUSGUI* _window, QWidget *parent) :
