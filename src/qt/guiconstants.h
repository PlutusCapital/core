...
/* Plutus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PLUTUS"
#define QAPP_ORG_DOMAIN "plutus.org"
#define QAPP_APP_NAME_DEFAULT "PLUTUS-Qt"
#define QAPP_APP_NAME_TESTNET "PLUTUS-Qt-testnet"
