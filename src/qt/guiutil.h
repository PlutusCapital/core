...
/** Utility functions used by the PLUTUS Qt UI.
 */
namespace GUIUtil
{
...
// Render PLUTUS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZplt = false);
