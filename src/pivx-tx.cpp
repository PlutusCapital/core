...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Plutus Core plutus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  plutus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded plutus transaction") + "\n" +
                               "  plutus-tx [options] -create [commands]   " + _("Create hex-encoded plutus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded plutus transaction
