/* src/config/plutus-config.h.  Generated from plutus-config.h.in by configure.  */
/* src/config/plutus-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.plutus.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Plutus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Plutus Core 3.4.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "plutus"
