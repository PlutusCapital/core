...
extern UniValue DoZpltSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpltseed(const UniValue& params, bool fHelp);
extern UniValue getzpltseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzplt(const UniValue& params, bool fHelp);
extern UniValue dzpltstate(const UniValue& params, bool fHelp);
