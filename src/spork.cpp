...
// Copyright (c) 2016-2018 The PLUTUS developers
...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 PLT
...
// PLUTUS: on startup load spork values from previous session if they exist in the sporkDB
