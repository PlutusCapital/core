...
from fake_stake.base_test import PLUTUS_FakeStakeTest

class zPLTwrappedSerialsTest(PLUTUS_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPLTs..." % DENOM_TO_USE)
