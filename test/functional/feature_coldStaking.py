...
from test_framework.plutus_node import PlutusTestNode
...
class PLUTUS_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(PlutusTestNode())
